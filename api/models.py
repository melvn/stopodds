...
class ModelType(str, Enum):
    ...
    LIGHTGBM = "lightgbm"
    BASELINE = "baseline"
    REGULARIZED_RIDGE = "regularized_ridge"
    REGULARIZED_LASSO = "regularized_lasso"
    REGULARIZED_ELASTIC_NET = "regularized_elastic_net"
    REGULARIZED_POISSON = "regularized_poisson"
    TREE_RANDOM_FOREST = "tree_random_forest"
    TREE_GRADIENT_BOOSTING = "tree_gradient_boosting"
    TREE_LIGHTGBM = "tree_lightgbm"
